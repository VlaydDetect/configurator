...
use super::error::{Path, PathComponentKind};
use super::Report;
            ...
            $T: Validate
        {
            ...
            fn validate_into(&self, ctx: &Self::Context, mut parent: &mut dyn FnMut() -> Path, report: &mut Report) {
                for (index, item) in self.iter().enumerate() {
                    let mut path = $crate::validator::util::nested_path!(parent, index);
    ...
    ($A:ident, $($T:ident),*) => {
            ...
            $($T : Validate<Context=$A::Context>,)*
        {
            ...
            fn validate_into(&self, ctx: &Self::Context, mut parent: &mut dyn FnMut() -> Path, report: &mut Report) {
                ...
                let _index = index;
                let mut path = $crate::validator::util::nested_path!(parent, _index);
    ...
    V: Validate,
{
    ...
    fn validate_into(
        ...
        for (key, value) in self.iter() {
            let mut path = crate::validator::util::nested_path!(parent, key);
