...
use crate::config::coalesce::Coalescible;
use crate::config::value::{Map, Dict};
use crate::config::error::Error;
use crate::config::util::nest;

use uncased::{Uncased, UncasedStr};

crate::config::util::cloneable_fn_trait!(
...
///
/// [key paths]: crate::config::Configurator#extraction
/// [`Value`]: crate::config::value::Value
/// [`Bool`]: crate::config::value::Value::Bool
/// [`Num::F64`]: crate::config::value::Num::F64
/// [`Num::USize`]: crate::config::value::Num::USize
/// [`Num::ISize`]: crate::config::value::Num::ISize
/// [`Array`]: crate::config::value::Value::Array
/// [`String`]: crate::config::value::Value::String
///
/// # Key Paths (nesting)
///
...
///     [`Source`](crate::config::Source). Interpolation makes path parts uppercase and
///     delimited with a `.`.
///
///   * **Data**
///
...
impl Env {
    ...
    /// use configurator::{Configurator, Jail, providers::Env};
    ///
    ...
    ///
    ///     let config: Config = Configurator::from(Env::raw()).extract()?;
    ...
    ///     jail.set_env("APP_BAR", "hi");
    ///
    ///     let config: Config = Configurator::from(Env::prefixed("APP_")).extract()?;
    ...
    /// use std::collections::HashMap;
    ///
    /// use configurator::{Jail, Profile, Provider};
    ...
    /// ```rust
    /// use serde::Deserialize;
    /// use configurator::{Configurator, Jail, config::util::map, value::Dict, providers::Env};
    ///
    /// #[derive(Debug, PartialEq, Deserialize)]
    /// struct Foo {
    ///     key: usize,
    ...
    ///
    /// ```rust
    /// use configurator::{Profile, providers::Env};
    ///
    /// let env = Env::raw();
