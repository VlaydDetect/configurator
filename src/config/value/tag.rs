...
use serde::{de, ser};
use crate::config::profile::{Profile, ProfileTag};
...
impl Tag {
    ...
    pub(crate) fn for_profile(self, profile: &Profile) -> Self {
...
impl From<Tag> for crate::config::value::Value {
    fn from(tag: Tag) -> Self {
        crate::config::value::Value::from(tag.0)
    }
}
