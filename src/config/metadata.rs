...
///     });
///
/// let profile = configurator::Profile::Default;
...
impl Metadata {
    ...
    ///
    /// ```rust
    /// use configurator::{Metadata, Profile};
    ///
...
impl fmt::Display for Source {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Source::File(p) => {
                use {std::env::current_dir, crate::config::util::diff_paths};
